...
<div class="row" id="bar">
    <div class="col-sm-10 heading" id="up">TravelEasy</div>
...
if(isset($_POST['deleteTrip']))
{
    ...
    if($resultx == True)
    {
		...
		require("C:/xampp/htdocs/TravelEasy/PHPMailer/src/PHPMailer.php");
		require("C:/xampp/htdocs/TravelEasy/PHPMailer/src/SMTP.php");
		require("C:/xampp/htdocs/TravelEasy/PHPMailer/src/Exception.php");
	    $mail = new PHPMailer;
